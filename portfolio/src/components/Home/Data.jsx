    ...
    return (
        <div className='home__data'>
            <h1 className='home__title' >
                Yuvraj <span style={{color:"#096B90"}}>Bhalla</span> 
                <svg
                    width='36'
                    height='36'
                    viewBox='0 0 48 48'
            ...
            <h3 className='home__subtitle' style={{color:"#08171E"}}>Full Stack Developer</h3>
            <p className='home__description'>

                As a dynamic and passionate web developer, I thrive on delivering innovative solutions fueled by creativity and seamless communication. My unwavering dedication to achieving extraordinary results ensures that I always bring my <span style={{color:"#08171E" , fontWeight:'bolder'}}>A-game</span>  to every project. With a relentless pursuit of excellence, I guarantee success and brilliance in every endeavor I embark upon.
            </p>
